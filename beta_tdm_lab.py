...
def main():
    ...
    print('rel_diam_o2_error:', 100*abs((d_eff_o2 - t_d_eff_o2)/t_d_eff_o2),
          'rel_diam_n2_error:', 100*abs((d_eff_n2 - t_d_eff_n2)/t_d_eff_n2))
main()